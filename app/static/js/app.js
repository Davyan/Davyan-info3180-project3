...
wishListApp.controller('profilesController' , ['$scope', '$http', '$log', '$cookies','$location','$rootScope',
...
wishListApp.config(function($routeProvider){
    $routeProvider.when('/signup',{
        templateUrl: 'static/js/partials/signup.html',
    ...
    when('/profiles', {
        templateUrl: 'static/js/partials/profiles.html',
